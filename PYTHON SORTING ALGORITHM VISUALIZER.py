...
#Creating vertical bars according to the value
...
#GENERATING ARRAY  (Array size and range can be changed)
def createArr():
    global arr
    array_size = 20   
    range_begin = 20
...
def sort():
    ...
    if algo_comboBox.get()=='Merge Sort':
        ...
        #INCOMPLETE
display_window = Frame(root, width= 900, height=300, bg="green")
...
canvas = Canvas(root, width=800, height=400, bg="grey")
